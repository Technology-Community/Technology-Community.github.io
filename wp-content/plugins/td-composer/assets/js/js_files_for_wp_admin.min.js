...
tdcWindowFrame.$_window.width()-100);f.top+100>tdcWindowFrame.$_window.height()&&(e.top=tdcWindowFrame.$_window.height()-100);b.isEmptyObject(e)||c.css(e)});"undefined"!==typeof tdcContextMenu&&tdcContextMenu.hide()});tdcWindowFrame._isInitialized=!0}},getCurrentWindowFramePosition:function(){return tdcWindowFrame._currentWindowPosition},setCurrentWindowFramePosition:function(a){tdcWindowFrame._currentWindowPosition="undefined"===typeof tdcWindowFrame.$_currentWindowFrame?c:tdcWindowFrame.$_currentWindowFrame.offset()},
...
setTimeout(function(){tdcWindowFrame.activeLastWindowFrame()},50)},activeLastWindowFrame:function(){var a=c,d=-1;b("."+tdcWindowFrame._markerCssClass).each(function(e,c){var f=b(c),g=parseInt(f.css("z-index"));g>d&&(d=g,a=f)});"undefined"!==typeof a&&a.removeClass("tdw-inactive")},getMarkerCssClass:function(){return tdcWindowFrame._markerCssClass}};b(window).load(function(){tdcWindowFrame.init(["#tdw-css-writer","#tdc-menu-settings","#tdc-page-settings","#tdc-wpeditor","#tdc-zone"])})})(jQuery);var tdcNotice;
(function(b,c){tdcNotice={$_noticeWrapper:c,_isInitialized:!1,_errorNotices:[],inError:!1,notice:function(a,d,b){var c={};_.isUndefined(d)||!0!==d||(c.type="error");_.isUndefined(b)||!0!==b||(c.hasClose=!0);tdcNotice.showNotice(a,c)},showNotice:function(a,d){if(tdcNotice._isInitialized){var c="",f="",k=!1,g=5E3;if("undefined"!==typeof d){if("undefined"!==typeof d.type)switch(d.type){case "error":c="tdc-notice-error";k=!0;break;case "info":c="tdc-notice-info"}"undefined"!==typeof d.hasClose&&!0===
d.hasClose&&(f='<div class="tdc-close-notice"></div>');"undefined"!==typeof d.timeout&&(g=d.timeout)}k&&(a+=" Current state has involved an issue. You could try an UNDO operation (CTRL+Z / CTRL+SHIFT+Z)");var h=b('<div class="tdc-notice '+c+'"><span class="tdc-msg-tag"></span>'+a+f+"</div>");tdcNotice.$_noticeWrapper.append(h);setTimeout(function(){h.addClass("tdc-notice-in")},100);if(k)throw tdcNotice._errorNotices.push(h),tdcNotice.inError=!0,tdcRecycle.init(),b("body").addClass("tdcComposerLoaded"),
...
(function(){tdcShortcodeParser={levels:{},init:function(b){tdcShortcodeParser.levels=_.clone(b);tdcShortcodeParser.levels[3]=tdcShortcodeParser.levels[3].concat(tdcShortcodeParser.levels[5])},multiNext:function(b,c){for(var a=tdcShortcodeParser.levels[b],d,e=0;e<a.length;e++){var f=tdcShortcodeParser.generateTreeElement(wp.shortcode.next(a[e],c));"undefined"!==typeof f&&("undefined"===typeof d||d.index>f.index)&&(d=f)}return d},parse:function(b,c){for(var a=tdcShortcodeParser.multiNext(b,c),d=0,e=
[];"undefined"!==typeof a&&5E3>d;)c=c.substring(a.index+a.content.length),5>b&&(a.child=tdcShortcodeParser.parse(b+1,a.content)),e.push(a),a=tdcShortcodeParser.multiNext(b,c),d++;return e},generateTreeElement:function(b){return b}}})();var tdcInit={};
