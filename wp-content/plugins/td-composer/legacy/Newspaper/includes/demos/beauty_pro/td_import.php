...
$td_cloud_global_header_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/header_cloud_template.txt',
...
$td_cloud_header_homepage_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/header_homepage_cloud_template.txt',
    'template_type' => 'header',
));
...
$td_cloud_header_overlay_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/header_overlay_cloud_template.txt',
    'template_type' => 'header',
));
...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/cat_cloud_template.txt',
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/post_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/author_cloud_template.txt',
...
$td_cloud_global_404_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/404_cloud_template.txt',
    'template_type' => '404'
));
...
$td_cloud_global_search_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/search_cloud_template.txt',
...
$td_cloud_global_date_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/date_cloud_template.txt',
    'template_type' => 'date'
));
...
$td_cloud_global_tag_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/tag_cloud_template.txt',
    'template_type' => 'tag'
));
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/homepage.txt',
...
$td_magazinepage_id = td_demo_content::add_page(array(
    'title' => 'Magazine',
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/magazine.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
...
$td_footerpage_id = td_demo_content::add_page(array(
    'title' => 'Footer',
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/footer.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
    'sidebar_position' => 'no_sidebar',
    'homepage' => false
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fashion_pro/pages/post_default.txt',
