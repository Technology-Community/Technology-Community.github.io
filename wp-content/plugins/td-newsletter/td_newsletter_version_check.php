 ...
 */
class td_newsletter_version_check {
	...
	static function on_admin_notice_theme_version() {
		...
		<div class="notice notice-error td-plugins-deactivated-notice">
			<p><strong>TD Newsletter</strong> - This plugin requires <strong><?php echo TD_THEME_NAME?> v<?php echo self::$theme_versions[TD_THEME_NAME] ?></strong> but the current installed version is <strong><?php echo TD_THEME_NAME?> v<?php echo TD_THEME_VERSION?></strong>. </p>

			<p>To fix this:</p>

			<ul>
				<li> - Delete the TD Newsletter plugin via wp-admin</li>
